...
public class ItemRidingIndicatingRod extends Item {
    ...
    {
        var2.heal(1);
        return itemInteractionForEntity(var1, var2);
    }

	@Override
	public void updateIcons(IconRegister par1IconRegister)
    {
        iconIndex = par1IconRegister.registerIcon(mod_RidingIndicatingRod.useOriginalIcon ? mod_RidingIndicatingRod.itemName : "blazeRod");
    }
/*
